...
Blockly.Procedures = Blockly.Procedures || {};
...
// TODO:  goog, also check

Blockly.FieldInstance = {};
Blockly.FieldDropdown = Blockly.FieldDropdown || {};Blockly.Instances = Blockly.Instances || {};Blockly.Msg = Blockly.Msg || {};Blockly.utils = Blockly.utils || {};goog.string = goog.string || {};
...
Blockly.Instances = {};
Blockly.Workspace = Blockly.Workspace || {};goog.string = goog.string || {};
...
Blockly.Instances.convertToUniqueName = function(instanceName, workspace) {
  var combinedList = Blockly.Variables.allVariables(workspace).concat(
    Blockly.Instances.allInstances(workspace));
  return Blockly.Instances.appendToName_(instanceName, combinedList, workspace);
};
...
Blockly.Instances.convertToUniqueNameBlock = function(instanceName, block) {
  ...
  if (block.workspace) {
    ...
    throw 'Not a valid Workspace for block: ' + block;
  }
  ...
  var combinedList = Blockly.Variables.allVariables(block.workspace).concat(
    instanceList);
  return Blockly.Instances.appendToName_(instanceName, combinedList, block.workspace);
};

/** */
Blockly.Instances.appendToName_ = function(instanceName, nameList, workspace = null) {
  if (!instanceName) {
    return Blockly.Instances.generateUniqueName(workspace);
  } else {
