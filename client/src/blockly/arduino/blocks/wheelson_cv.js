...
Blockly.defineBlocksWithJsonArray([
	{
		type: "wheelson_ball_detect",
		message0: "detect ball %1",
		args0: [
			{
				type: "field_dropdown",
				name: "HUE",
		...
		outputShape: Blockly.OUTPUT_SHAPE_SQUARE,
		colour: Blockly.Msg.WHEELSON_HUE,
		tooltip: "Detect ball on last camera frame",
		helpUrl: ""
	}
]);

Blockly.Blocks["wheelson_ball_detected"] = {
	init: function () {
		this.jsonInit({
			type: "wheelson_ball_detected",
			message0: "when ball is detected",
			message1: "%1",
			args1: [{
				type: "input_statement",
				name: "CODE"
			...
			outputShape: Blockly.OUTPUT_SHAPE_SQUARE,
			colour: Blockly.Msg.WHEELSON_HUE,
			tooltip: "When a ball is detected",
			helpUrl: ""
		});
		...
		this.functionId_ = "Ball_detectedFunc";
		this.name_ = "ballDetected";
	},
