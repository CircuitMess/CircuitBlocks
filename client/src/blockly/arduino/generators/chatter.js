...
goog.provide("Blockly.Arduino.Chatter");

Blockly.Arduino.additionals["Chatter"] = function(){
  Blockly.Arduino.addInclude("AR_include", "#include <Arduino.h>");
  Blockly.Arduino.addInclude("COS_include", "#include <CircuitOS.h>");
  Blockly.Arduino.addInclude("Chat_include", "#include <Chatter.h>");
  ...
  Blockly.Arduino.addSetup("Chat_begin", "Chatter.begin();");
  Blockly.Arduino.addSetup("Disp_get", "display = Chatter.getDisplay();");
