...
export const Devices: { [name: string]: Device } = {
  ...
  "cm:esp32:jayd": { fqbn: "cm:esp32:jayd", name: "JayD" },
};
        ...
        >
          ...
          {loggedIn ? (
              <>
                ...
                <Footer>
                  <p>v1.3.1 <span style={{ padding: "0 10px" }}>|</span> <a style={{ cursor: "pointer" }} onClick={ () => this.openErrorReport() }>Send error report</a></p>
                </Footer>
              </>
          ) : (
